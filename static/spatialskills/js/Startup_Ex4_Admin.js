...
function startup() {
    ...
    var isometricCanvasIds = ["isometricEx4"];
    var preImageCanvasIds = ["isometricPreImageEx4"];
    var rotationCanvasIds = ["rotationsEx4"];
    ...
    for (var i = 0; i < rotationCanvasIds.length; i++){
        ...
        setUpButtonsAlphabetic(canvasObj);
...
function writeToJSON(question){
    ...
    var exercise_obj = {ex_num:4,ex_data:JSON.stringify(tempQuestion)}
