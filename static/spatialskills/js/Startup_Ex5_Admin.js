...
function startupEx5() {
    ...
    var isometricCanvasIds = ["isometricEx5"];
    var preImageCanvasIds = ["isometricPreImageEx5"];
    var rotationCanvasIds = ["rotationsEx5"];
...
function writeToJSON(question){
    ...
    var exercise_obj = {ex_num:5,ex_data:JSON.stringify(tempQuestion)}
